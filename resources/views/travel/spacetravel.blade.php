<!DOCTYPE html>
<html xmlns:inkscape="urn:oasis:names:tc:xliff:document:1.2">
<head>
    ...
    <link type="text/css" href="{{url('css/spacetravel.css')}}" rel="stylesheet">
    <title>Space travel calculator</title>

    <link type="text/css" href="{{url('css/ui-lightness/jquery-ui-1.8.20.custom.css')}}" rel="Stylesheet"/>
    ...
    <script type="text/javascript" src="{{url('js/spacetravel.js')}}"></script>
    <script type="text/javascript" src="{{url('js/spaceanimation.js')}}"></script>
    <script type="text/javascript" src="{{url('js/spacestart.js')}}"></script>
...
<div id="content">
    ...
    <div class="text">
        ...
        <p>Then you can use this calculator to work out how long it will take you, how much energy your spacecraft needs
            and what your maximum velocity will be. If you travel close to the speed of light, you can also see how much
            time it will take from your point of view and from the point of view of the people on earth. You can also
            see how the length of your spacecraft will shorten for observers watching it from earth, if only they had
            powerful enough telescopes.</p>
        ...
        <ol>
            ...
            <li>
                ...
                <em>Pr</em> and press the down arrow. The distance to Proxima Centauri appears. Select it and the
                distance will be filled in. Try other places in space.
            ...
            <li>
                Click <em>Run</em>. Watch the space rocket travel from earth to your destination. Also watch the clocks
                of the observer and the traveler.
            </li>
        ...
        <form name="time_dilation" class="formstyle">
            ...
            <div id="buttons">
                ...
                <button onclick="calculate()" type="button"
                        title="Calculate unfilled fields">Calculate
                </button>

                <button onclick="clearFields()" type="button"
                        title="Clears the fields and sets some of them to default values">Clear
                </button>
    ...
    <div id="animation">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" id="svg-viewer" xmlns:xlink="http://www.w3.org/1999/xlink" width="900"
             height="160">
            ...
            <svg id="observer" x="0" y="55">
                ...
                <g
                    ...
                    <path
                            style="fill:#00A;stroke:#000000;stroke-width:0.25px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
